...
- **ETH 는 가장 어렵고 가장 불안정하다.** 테스트 보행자가 181명뿐이라 best-of-20 표준편차가 크고, 공식 체크포인트도 0.73/1.21 이다.
  학습 시드 3개에서 ADE 0.74 / 0.66 / 0.72 (평균 0.71 ± 0.04, §2.1)로, 논문(0.64)과의 차이는 시드 분산 안이다.
  zara1 은 0.34 / 0.43 / 0.35 로 seed 1 만 튀었다. 한 시드의 분할별 순위는 믿을 것이 못 되고, 평균과 분산을 같이 봐야 한다.
...
|---|---|---|---|---|
| eth | 0.74/1.32 | 0.66/1.18 | 0.72/1.17 | 0.707 ± 0.042 |
| hotel | 0.46/0.77 | 0.43/0.76 | 0.44/0.69 | 0.443 ± 0.014 |
| univ | 0.47/0.86 | 0.53/0.98 | 0.49/0.87 | 0.496 ± 0.035 |
| zara1 | 0.34/0.54 | 0.43/0.70 | 0.35/0.53 | 0.375 ± 0.048 |
| zara2 | 0.33/0.55 | 0.34/0.54 | 0.34/0.54 | 0.337 ± 0.005 |
<!-- SEEDS_TABLE:END -->

같은 설정으로 학습 시드만 바꾼 결과. 표준편차는 표본 표준편차(ddof=1). 3시드 평균의 5분할 평균 ADE 는 0.472 (seed 0 만으로는 0.47, 논문 0.44).
