...
- **ETH 는 가장 어렵고 가장 불안정하다.** 테스트 보행자가 181명뿐이라 best-of-20 표준편차가 크고, 공식 체크포인트도 0.73/1.21 이다.
  ...
  반대로 zara1 은 seed 1 에서 0.34 → 0.43 으로 나빠졌다. 한 시드의 분할별 순위는 믿을 것이 못 되고, 평균과 분산을 같이 봐야 한다.
...
| zara1 | 0.34/0.54 | 0.43/0.70 | - | 0.387 ± 0.060 |
| zara2 | 0.33/0.55 | 0.34/0.54 | - | 0.335 ± 0.003 |
<!-- SEEDS_TABLE:END -->
